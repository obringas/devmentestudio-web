...
export class BadgeComponent {
  ...
  get badgeClasses(): Record<string, boolean> {
    return {
      ...
      // Variants
      'bg-primary-500/10 text-primary-700 border border-primary-500/20': this.variant() === 'primary',
      'bg-accent-500/10 text-accent-700 border border-accent-500/20': this.variant() === 'accent',
