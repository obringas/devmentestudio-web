    ...
    @if (service(); as srv) {
      <div class="min-h-screen">
        ...
        <section class="bg-surface-50 py-16 lg:py-24">
          <div class="container-custom">
            <h2 class="mb-12 text-2xl font-display font-bold text-surface-900 md:text-3xl">
              {{ copy().includes }}
            </h2>
            ...
            <div class="grid gap-8 md:grid-cols-3">
              @for (benefit of srv.benefits; track benefit.title) {
                <div class="text-center">
                  ...
                  <h3 class="mb-2 text-xl font-display font-semibold text-surface-900">
                    {{ benefit.title }}
                  </h3>
      ...
      <div class="flex min-h-screen items-center justify-center px-6">
        <div class="text-center">
          <h1 class="mb-4 text-2xl font-display font-bold text-surface-900">{{ copy().notFoundTitle }}</h1>
