    ...
    <div class="min-h-screen">
      <section class="relative overflow-hidden py-16 lg:py-24">
        <div class="absolute inset-0 -z-10">
          ...
          <div class="absolute bottom-0 right-1/4 h-96 w-96 rounded-full bg-primary-300/10 blur-3xl"></div>
        </div>
            ...
            @for (service of services(); track service.id) {
              ...
              >
                <div class="flex flex-col justify-center">
                  <div class="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-primary-500/20 to-primary-200/30">
                    @switch (service.icon) {
                      @case ('refresh-cw') {
                        <svg class="h-7 w-7 text-primary-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h2 class="mb-4 text-2xl font-display font-bold text-surface-900 transition-colors group-hover:text-primary-700 md:text-3xl">
                    {{ service.title }}
                  </h2>
                  ...
                  <div class="flex items-center font-medium text-primary-700">
                ...
                <div class="rounded-[1.5rem] bg-surface-50 p-5 sm:p-6">
                  <h3 class="mb-4 text-lg font-semibold text-surface-800">{{ copy().includes }}</h3>
                  <ul class="space-y-3">
                    @for (feature of service.features; track feature) {
                      <li class="flex items-start gap-3">
                        <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-accent-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  readonly copy = computed(() => (
    this.language() === 'en'
      ? {
          ...
          description:
            'We modernize management systems, connect critical processes and build the digital tools your company needs to keep moving forward.',
      ...
      : {
          ...
          title: 'Software pensado desde la operación de tu empresa',
          description:
            'Modernizamos sistemas de gestión, conectamos procesos críticos y construimos las herramientas digitales que tu empresa necesita para seguir avanzando.',
