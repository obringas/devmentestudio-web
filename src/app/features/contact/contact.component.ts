              ...
              <div class="space-y-6 mb-12">
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hola@devmentestudio.com" class="text-surface-400 hover:text-primary-400 transition-colors">
                      hola&#64;devmentestudio.com
                    </a>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/5493877XXXXXX" target="_blank" rel="noopener noreferrer" class="text-surface-400 hover:text-green-400 transition-colors">
                      +54 9 387 XXX XXXX
                    </a>
                  </div>
                </div>
...
export class ContactComponent {
  ...
  readonly socials = [
    { 
      name: 'LinkedIn', 
      url: 'https://linkedin.com/company/devmentestudio',
    ...
    { 
      name: 'GitHub', 
      url: 'https://github.com/devmentestudio',
    ...
    { 
      name: 'Twitter', 
      url: 'https://twitter.com/devmentestudio',
